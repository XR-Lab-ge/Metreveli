Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/e2317cc6f144d4446a590ff232e6e6c1"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.1.14</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISTORTIONFLOWTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector = POI2D_SAMPLER_PAN(_DistortionFlowTexture, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DistortionFlowTextureUV*/)], float4(1,1,0,0)), float4(1,-1,0,0)) * 2 - 1;
				#else
				float4 flowVector = -1;
				#endif
				#if defined(PROP_DISTORTIONFLOWTEXTURE1) || !defined(OPTIMIZER_ENABLED)
				float4 flowVector1 = POI2D_SAMPLER_PAN(_DistortionFlowTexture1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DistortionFlowTexture1UV*/)], float4(1,1,0,0)), float4(-1,1,0,0)) * 2 - 1;
				#else
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.634 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.758 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.758 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.758 /*_ShadowBlur*/) * blurMap.r);
					...
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.5 /*_ShadowBorder*/), (0.758 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if (float4(0.2319224,0.2319224,0.2319224,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.2319224,0.2319224,0.2319224,1).rgb;
				}
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalTexture_ST = float4(2,2,0,0);
				Decal0.m_DecalTexturePan = float4(-0.05,-0.4,0,0);
				Decal0.m_DecalTextureUV = (7.0 /*_DecalTextureUV*/);
				Decal0.m_DecalColor = float4(0.4254881,0.4615407,1,1);
				Decal0.m_DecalColorThemeIndex = (0.0 /*_DecalColorThemeIndex*/);
				Decal0.m_DecalTiled = (1.0 /*_DecalTiled*/);
				Decal0.m_DecalBlendType = (5.0 /*_DecalBlendType*/);
				...
				Decal0.m_DecalHueShiftSpeed = (0.22 /*_DecalHueShiftSpeed*/);
				Decal0.m_DecalDepth = (0.03 /*_Decal0Depth*/);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.143 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.645 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				#endif
				matcapIntensity = (1.89 /*_Matcap2Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.104 /*_Matcap2Add*/), (0.033 /*_Matcap2AddToLight*/), (0.444 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.119 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.41 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			{
				float enviroRimAlpha = saturate(1 - smoothstep(min((0.205 /*_RimEnviroSharpness*/), (0.354 /*_RimEnviroWidth*/)), (0.354 /*_RimEnviroWidth*/), poiCam.vDotN));
				...
				#endif
				float3 envRimCol = lerp(0, max(0, (enviroRimColor - (0.0 /*_RimEnviroMinBrightness*/)) * poiFragData.baseColor), enviroRimAlpha).rgb * enviroMask * (0.3 /*_RimEnviroIntensity*/);
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.379 /*_HighColor_Power*/)))) * (0.059 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.263 /*_Layer2Size*/)))) * (0.077 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.379 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (0.059 /*_Layer1Strength*/);
					specMask2 += poiEdgeNonLinear(specArea, (1.0 - pow((0.263 /*_Layer2Size*/), 5)), (0.032 /*_StylizedSpecular2Feather*/)) * (0.077 /*_Layer2Strength*/);
				}
				#if defined(PROP_SET_HIGHCOLORMASK) || !defined(OPTIMIZER_ENABLED)
				...
				float specularMask = 1;
				#endif
				if((1.0 /*_StylizedSpecularInvertMask*/))
				{
					specularMask = 1 - specularMask;
				}
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.379 /*_HighColor_Power*/)))) * (0.059 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.263 /*_Layer2Size*/)))) * (0.077 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.379 /*_HighColor_Power*/), 5)), (0.0 /*_StylizedSpecularFeather*/)) * (0.059 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, poiEdgeNonLinear(specArea, (1.0 - pow((0.263 /*_Layer2Size*/), 5)), (0.032 /*_StylizedSpecular2Feather*/)) * (0.077 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
			...
			{
				float3 parallax = 0;
				for (int j = (8.0 /*_ParallaxInternalIterations*/) - 1; j >= 0; j--)
				{
					float ratio = saturate((float)j / max((8.0 /*_ParallaxInternalIterations*/) - 1, 1));
					float2 parallaxOffset = _Time.y * (float4(-0.001,-0.0025,1,1) + ratio * float4(0.01,0.05,1,1));
					float fade = lerp((3.63 /*_ParallaxInternalMinFade*/), (0.747 /*_ParallaxInternalMaxFade*/), ratio);
					fade = pow(fade, 2.2);
					#if defined(PROP_PARALLAXINTERNALMAP) || !defined(OPTIMIZER_ENABLED)
					float4 parallaxColor = UNITY_SAMPLE_TEX2D_SAMPLER(_ParallaxInternalMap, _MainTex, TRANSFORM_TEX(poiMesh.uv[0], _ParallaxInternalMap) + (lerp((0.02 /*_ParallaxInternalMinDepth*/), (0.4 /*_ParallaxInternalMaxDepth*/), ratio)) * - (poiCam.tangentViewDir.xy / (poiCam.tangentViewDir.z)) + parallaxOffset);
					#else
					float4 parallaxColor = 0;
					#endif
					float3 minColor = poiThemeColor(poiMods, float4(0.250646,0.250646,0.250646,1).rgb, (0.0 /*_ParallaxInternalMinColorThemeIndex*/));
					float3 maxColor = poiThemeColor(poiMods, float4(0.01742646,0.01742646,0.3936214,1).rgb, (0.0 /*_ParallaxInternalMaxColorThemeIndex*/));
					...
					parallaxTint = hueShift(parallaxTint, frac(ratio * (0.25 /*_ParallaxInternalHueShiftPerLevel*/)) * (1.0 /*_ParallaxInternalHueShiftEnabled*/));
				...
				parallax = hueShift(parallax, frac((0.0 /*_ParallaxInternalHueShift*/) + (2.0 /*_ParallaxInternalHueShiftSpeed*/) * _Time.x) * (1.0 /*_ParallaxInternalHueShiftEnabled*/));
				#if defined(PROP_PARALLAXINTERNALMAPMASK) || !defined(OPTIMIZER_ENABLED)
				poiFragData.baseColor.rgb = customBlend(poiFragData.baseColor.rgb, parallax.rgb, (9.0 /*_ParallaxInternalSurfaceBlendMode*/), POI2D_SAMPLER_PAN(_ParallaxInternalMapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ParallaxInternalMapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_ParallaxInternalMapMaskChannel*/)]);
				#else
				poiFragData.baseColor.rgb = customBlend(poiFragData.baseColor.rgb, parallax.rgb, (9.0 /*_ParallaxInternalSurfaceBlendMode*/));
				#endif
			}
			#endif
			#if defined(POI_SSAO)
			float CalculateAmbientOcclusion(float2 uv, float depth, float3 normal, float radius, float4 worldDirection, PoiMesh poiMesh, PoiCam poiCam)
			{
				...
				int totalSamples = int((10.0 /*_SSAOQuality*/) * AO_DIRECTIONS * smoothstep((8.0 /*_SSAOFalloffEnd*/), (6.0 /*_SSAOFalloffStart*/), poiCam.clipPos.w));
				...
				{
					int i = sampleIndex / int((10.0 /*_SSAOQuality*/));
					int j = sampleIndex % int((10.0 /*_SSAOQuality*/));
					float distance = float(j) * 1.0 / ((10.0 /*_SSAOQuality*/) - 1);
					float sampleAngle = TWO_PI * (float(i) / AO_DIRECTIONS + float(j + 1) / (10.0 /*_SSAOQuality*/));
					float s, c;
					...
					float2 screenOffset = (sampleDir.xy + (distance * ((0.0 /*_SSAORandomScale*/) * .2) * (random2(poiMesh.uv[0] + i * j) * 2 - 1))) * radiusFactor * offsetFactor;
					...
					aoValue *= smoothstep(max(radius + float4(0.01,0.5,1,1).x + EPSILON, radius + float4(0.01,0.5,1,1).y), radius + float4(0.01,0.5,1,1).x, depthDifference);
					ao += aoValue;
				}
				return 1.0 - saturate((ao / totalSamples) * (1.0 /*_SSAOIntensity*/)) * smoothstep((8.0 /*_SSAOFalloffEnd*/), (6.0 /*_SSAOFalloffStart*/), poiCam.clipPos.w);
			}
			float calculateSSAO(PoiMesh poiMesh, PoiCam poiCam, inout PoiLight poiLight, inout PoiMods poiMods)
			{
				...
				float3 transformedNormal = mul((float3x3)UNITY_MATRIX_V, poiMesh.normals[1]);
				float mask = 1;
			...
			void applySSAO(float ssao, in PoiMesh poiMesh, inout PoiFragData poiFragData, inout PoiMods poiMods, inout PoiLight poiLight)
			{
				...
				#endif
				poiFragData.baseColor = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, ssaoColor, (2.0 /*_SSAOBlendType*/)), 1 - ssao);
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				#if defined(POI_SSAO)
				if (_CameraDepthTexture_TexelSize.z < 16) return 1;
				...
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((0.244 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (0.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (3.91 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.053 /*_RimWidth*/), (0.144 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0.04970655,0.04970655,0.04970655,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (0.0 /*_RimHueShiftSpeed*/),  (0.134 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (3.95 /*_RimBrightness*/), (1.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef POI_STYLIZED_StylizedSpecular
