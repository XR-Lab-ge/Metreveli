Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/d17584a28c3eeed48b08e6ed52cb54d1"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (0.89 /*_OutlinesMaxDistance*/)), (1.0 /*_OutlineFixWidth*/));
				}
				float lineWidth = (0.4 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(60,60,0,0)), float4(0,0,0,0), (1.0 /*_DetailNormalMapStochastic*/)), (0.44 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void stylizedSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.606 /*_HighColor_Power*/)))) * (0.032 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.606 /*_HighColor_Power*/), 5)), (0.275 /*_StylizedSpecularFeather*/)) * (0.032 /*_Layer1Strength*/);
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.606 /*_HighColor_Power*/)))) * (0.032 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.606 /*_HighColor_Power*/), 5)), (0.275 /*_StylizedSpecularFeather*/)) * (0.032 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
